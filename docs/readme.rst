This is the folder for building the complete documentation for the Vibration Testing module. The actual documentation is hosted via `githubpages <http://Vibration-Testing.github.io/vibrationtesting/>`_.
